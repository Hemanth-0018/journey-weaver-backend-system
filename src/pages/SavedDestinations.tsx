...
const SavedDestinations: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <h1 className="text-3xl font-bold mb-8">Saved Destinations</h1>
        
        <div className="p-12 text-center bg-muted rounded-lg">
          <p className="text-xl mb-4">This page is under construction</p>
          <p className="text-muted-foreground">Your saved destinations will be shown here</p>
        </div>
      </main>
